...
import { getAllFamilles, deleteOneFamille } from "../../redux/slices/famille";
...
const FamilleList = () => {
  const { familles, loading } = useSelector((state) => state.familles);
      ...
      <div className={classes.content}>
        ...
        <Collapse in={filtersOpen}>
          <Filter
            ...
            handelFilter={getAllFamilles}
          />
        </Collapse>
        <Table
          deleteItem={deleteOneFamille}
          loading={loading}
          columns={columns}
          data={familles}
